 ...
 */
class Gri_Reward_Block_Adminhtml_Sales_Order_Create_Payment extends Mage_Core_Block_Template
{
    /**
     * Getter
     *
    ...
    public function canUseRewardPoints()
    {
        ...
        $minPointsBalance = (int)Mage::getStoreConfig(Gri_Reward_Model_Reward::XML_PATH_MIN_POINTS_BALANCE, $this->getQuote()->getStoreId());

        return $this->getReward()->getPointsBalance() >= $minPointsBalance 
            && Mage::helper('gri_reward')->isEnabledOnFront($websiteId)
    ...
    protected function _toHtml()
    {
        ...
        $rewardFormatted = Mage::helper('gri_reward')
