 ...
 * @package    Gri_Cms
 */
class Gri_Cms_Helper_Hierarchy extends Mage_Core_Helper_Abstract
{
    ...
    {
        if ($scope === Gri_Cms_Model_Hierarchy_Node::NODE_SCOPE_STORE) {
            return array(
                Gri_Cms_Model_Hierarchy_Node::NODE_SCOPE_WEBSITE,
                Mage::app()->getStore($scopeId)->getWebsiteId(),
            );
        } elseif ($scope === Gri_Cms_Model_Hierarchy_Node::NODE_SCOPE_WEBSITE) {
            return array(
                Gri_Cms_Model_Hierarchy_Node::NODE_SCOPE_DEFAULT,
                Gri_Cms_Model_Hierarchy_Node::NODE_SCOPE_DEFAULT_ID,
            );
        }
