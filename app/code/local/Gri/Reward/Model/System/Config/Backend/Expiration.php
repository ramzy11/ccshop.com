 ...
 *
 */
class Gri_Reward_Model_System_Config_Backend_Expiration extends Mage_Core_Model_Config_Data
{
    const XML_PATH_EXPIRATION_DAYS = 'gri_reward/general/expiration_days';

    /**
     * Update history expiration date to simplify frontend calculations
     *
     * @return Gri_Reward_Model_System_Config_Backend_Expiration
     */
