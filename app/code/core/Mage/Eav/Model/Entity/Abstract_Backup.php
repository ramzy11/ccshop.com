...
Mage::log('$part:'.$part, 7, 'Mage.Eav_Model.Entity.Abstract.walkAttributes.log');
Mage::log('$method:'.$method, 7, 'Mage.Eav_Model.Entity.Abstract.walkAttributes.log');
Mage::log('$attrCode:'.$attrCode, 7, 'Mage.Eav_Model.Entity.Abstract.walkAttributes.log');
Mage::log('$instance Class:'.get_class($instance), 7,'Mage.Eav_Model.Entity.Abstract.walkAttributes.log');
Mage::log('$args:'.var_export($args,true), 7,'Mage.Eav_Model.Entity.Abstract.walkAttributes.log');
                throw $e;
            } catch (Exception $e) {
