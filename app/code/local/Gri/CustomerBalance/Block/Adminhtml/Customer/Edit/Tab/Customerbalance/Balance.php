...
class Gri_CustomerBalance_Block_Adminhtml_Customer_Edit_Tab_Customerbalance_Balance extends Mage_Adminhtml_Block_Template
{
    /**
    ...
    public function getDeleteOrphanBalancesButton()
    {
        ...
        if ($balance->getOrphanBalancesCount($customer->getId()) > 0) {
            return $this->getLayout()->createBlock('adminhtml/widget_button')->setData(array(
                'label'     => Mage::helper('gri_customerbalance')->__('Delete Orphan Balances'),
