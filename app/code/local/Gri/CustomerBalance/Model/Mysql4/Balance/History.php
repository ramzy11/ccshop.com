 ...
 *
 */
class Gri_CustomerBalance_Model_Mysql4_Balance_History extends Mage_Core_Model_Mysql4_Abstract
{
    /**
     * Initialize resource
     *
    ...
    {
        $this->_init('gri_customerbalance/balance_history', 'history_id');
    }
     ...
     * @return Gri_CustomerBalance_Model_Mysql4_Balance_History
     */
