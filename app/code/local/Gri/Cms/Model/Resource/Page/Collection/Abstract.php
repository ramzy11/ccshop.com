 ...
 */
abstract class Gri_Cms_Model_Resource_Page_Collection_Abstract
    extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
     ...
     *
     * @param mixed $page
     * @return Gri_Cms_Model_Resource_Page_Collection_Abstract
     */
     ...
     * @return Gri_Cms_Model_Resource_Page_Collection_Abstract
     */
    public function addVisibilityFilter($userId, $accessLevel = Gri_Cms_Model_Page_Version::ACCESS_LEVEL_PUBLIC)
    {
        $_condition = array();
        ...
        if (!$this->_usersHash) {
            ...
            foreach ($this->_toOptionHash('user_id', 'username') as $userId => $username) {
                if ($userId) {
                    ...
                    $this->_usersHash['-1'] = Mage::helper('gri_cms')->__('[No Owner]');
                }
            }
