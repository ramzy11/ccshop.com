...
class BusinessDecision_Interaktingslider_Model_Mysql4_Slide extends Mage_Core_Model_Mysql4_Abstract
{
	...
	protected function _beforeSave(Mage_Core_Model_Abstract $object)
	{
		...
		if (! $object->getFromTime()) {
			...
			$object->setFromTime( Mage::app()->getLocale()->date($object->getFromTime(),$dateFormatIso, NULL, FALSE));
		...
		if (! $object->getToTime()) {
			...
			$object->setToTime( Mage::app()->getLocale()->date($object->getToTime(),$dateFormatIso, NULL, FALSE));
