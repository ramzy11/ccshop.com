...
class Gri_GiftCard_Model_Mysql4_Catalogindex_Data_Giftcard extends Mage_CatalogIndex_Model_Mysql4_Data_Abstract
{
    ...
    public function getAmounts($product, $store)
    {
        ...
        if (!isset($this->_cache[$key])) {
            $select = $this->_getReadAdapter()->select()
                ->from($this->getTable('gri_giftcard/amount'), array('value', 'website_id'))
