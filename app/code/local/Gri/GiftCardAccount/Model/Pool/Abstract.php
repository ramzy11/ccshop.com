...
abstract class Gri_GiftCardAccount_Model_Pool_Abstract extends Mage_Core_Model_Abstract
{
    const STATUS_FREE = 0;
    const STATUS_USED = 1;
    ...
    public function shift()
    {
        ...
        if (!$items = $collection->getItems()) {
            Mage::throwException(Mage::helper('gri_giftcardaccount')->__('No codes left in the pool.'));
        }
