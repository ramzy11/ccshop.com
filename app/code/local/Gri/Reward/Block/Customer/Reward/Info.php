 ...
 */
class Gri_Reward_Block_Customer_Reward_Info extends Mage_Core_Block_Template
{
    /**
    ...
    protected function _toHtml()
    {
        ...
        if ($customer && $customer->getId()) {
            $this->_rewardInstance = Mage::getModel('gri_reward/reward')
    ...
    {
        $maxBalance = (int)Mage::helper('gri_reward')->getGeneralConfig('max_points_balance');
        $minBalance = (int)Mage::helper('gri_reward')->getGeneralConfig('min_points_balance');
        ...
        $this->addData(array(
            ...
            'expire_in' => (int)Mage::helper('gri_reward')->getGeneralConfig('expiration_days'),
            'is_history_published' => (int)Mage::helper('gri_reward')->getGeneralConfig('publish_history'),
        ));
    }
}
