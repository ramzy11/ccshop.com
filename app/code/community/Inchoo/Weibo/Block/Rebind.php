 ...
 */
class Inchoo_Weibo_Block_Rebind extends Mage_Directory_Block_Data
{
    /**
    ...
    {
        $this->getLayout()->getBlock('head')->setTitle(Mage::helper('customer')->__('Rebind Weibo  Account'));
    ...
    {
        return $this->helper('inchoo_weibo')->getRebindPostUrl();
    }
    
    
    public  function getSuccessUrl(){
        return  Mage::helper('inchoo_weibo')->getSuccessUrl(); 
    }
