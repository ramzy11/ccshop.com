...
class Gri_GiftCardAccount_Block_Sales_Order_Giftcards extends Mage_Core_Block_Template
{
    /**
    ...
    public function getGiftCards()
    {
        ...
        $cards = Mage::helper('gri_giftcardaccount')->getCards($this->getOrder());
     ...
     *
     * @return Gri_GiftCardAccount_Block_Sales_Order_Giftcards
     */
