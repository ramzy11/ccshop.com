...
class Inchoo_Weibo_TestController extends Mage_Core_Controller_Front_Action {
    ...
    public function restTest2Action() {
        try {
            $result = $this->_getSession()->getClient()->call('stream.publish', array(
    ...
    public function localeTestAction() {
        var_dump(Mage::getModel('inchoo_weibo/locale')->getOptionLocales());
