(function ($) {
    ...
    jqzoom = function (g, h) {
        ...
        g.mousepos = {};
        g.mouseDown = false;
        $(g).css({'outline-style':'none', 'text-decoration':'none'});
        var m = $("img:eq(0)", g);
        ...
        $.extend(k, {create:function () {
            ...
            if (l.zoomType == 'drag') {
                ...
                $(".zoomPad", g).css({cursor:'default'});
                $(".zoomPup", g).css({cursor:'move'})
            }
            if (l.zoomType == 'innerzoom') {
                $(".zoomWrapper", g).css({cursor:'crosshair'})
            }
            ...
            d.each(function () {
                ...
                $(this).click(function (e) {
                    $('#media-switcher li[type=image]').click();
        ...
        function Lens() {
            ...
            this.setdimensions = function () {
                ...
                if (l.zoomType == 'reverse') {
                    ...
                    $(this.image).css({position:'absolute', display:'block', left:-(this.node.left + 1 - p.bleft) + 'px', top:-(this.node.top + 1 - p.btop) + 'px'})
                }
            };
            ...
            this.setposition = function (e) {
                ...
                this.node.left = b;
                this.node.top = c;
                this.node.css({'left':b + 'px', 'top':c + 'px'});
                if (l.zoomType == 'reverse') {
        ...
        function Stage() {
            ...
            this.append = function () {
                ...
                if (l.zoomType == 'innerzoom') {
                    ...
                    $('.zoomWrapper', this.node).css({borderWidth:a + 'px'})
                }
                $('.zoomWrapper', this.node).css({width:Math.round(l.zoomWidth) + 'px', borderWidth:a + 'px'});
                $('.zoomWrapperImage', this.node).css({width:'100%', height:Math.round(l.zoomHeight) + 'px'});
        ...
        function Largeimage() {
            ...
            this.setposition = function () {
                ...
                $(this.node).css({'left':a + 'px', 'top':b + 'px'})
            };
            return this
        }
    ...
    $.jqzoom = {defaults:{zoomType:'standard', zoomWidth:300, zoomHeight:300, xOffset:10, yOffset:0, position:"right", preloadImages:true, preloadText:'Loading zoom', title:true, lens:true, imageOpacity:0.4, alwaysOn:false, showEffect:'show', hideEffect:'hide', fadeinSpeed:'slow', fadeoutSpeed:'2000'}, disable:function (a) {
        var b = $(a).data('jqzoom');
        b.disable();
        return false
    }, enable:function (a) {
