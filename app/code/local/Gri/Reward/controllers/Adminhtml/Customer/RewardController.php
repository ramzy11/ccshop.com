 ...
 */
class Gri_Reward_Adminhtml_Customer_RewardController extends Mage_Adminhtml_Controller_Action
{
    /**
    ...
    public function historyAction()
    {
        ...
        $history = $this->getLayout()
            ->createBlock('gri_reward/adminhtml_customer_edit_tab_reward_history', '',
    ...
    public function historyGridAction()
    {
        $customerId = $this->getRequest()->getParam('id', 0);
        $history = $this->getLayout()
            ->createBlock('gri_reward/adminhtml_customer_edit_tab_reward_history_grid', '',
                array('customer_id' => $customerId));
        $this->getResponse()->setBody($history->toHtml());
    }
    ...
    public function deleteOrphanPointsAction()
    {
        ...
        if ($customerId) {
            try {
                ...
                $this->_getSession()
                    ->addSuccess(Mage::helper('gri_reward')->__('The orphan points have been removed.'));
            } catch (Exception $e) {
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('gri_reward/balance');
    }
}
