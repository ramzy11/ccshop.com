...
class AW_Rma_Block_Customer_View extends Mage_Core_Block_Template {
    ...
    protected function _prepareLayout() {
        ...
        $breadcrumbs->addCrumb('return-exchange', array('label' => $this->__('Return or Exchange'), 'title' => $this->__('Return or Exchange'), 'link' => $this->getUrl('awrma/customer_rma/list/')));
        $breadcrumbs->addCrumb('return-exchange-detail', array('label' => $this->__('Return or Exchange'), 'title' => $this->__('Return or Exchange')));
