 ...
 */
class Gri_Cms_Model_Resource_Hierarchy_Node_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    /**
    ...
    public function joinMetaData()
    {
        if (!$this->getFlag('meta_data_joined')) {
            $this->getSelect()
                ->joinLeft(array('metadata_table' => $this->getTable('gri_cms/hierarchy_metadata')),
