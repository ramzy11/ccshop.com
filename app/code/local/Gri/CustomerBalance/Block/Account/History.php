 ...
 *
 */
class Gri_CustomerBalance_Block_Account_History extends Mage_Core_Block_Template
{
    /**
    ...
    {
        return Mage::getStoreConfigFlag('customer/gri_customerbalance/show_history');
    }
    ...
    public function getActionNames()
    {
        if (is_null($this->_actionNames)) {
            $this->_actionNames = Mage::getSingleton('gri_customerbalance/balance_history')->getActionNamesArray();
        }
