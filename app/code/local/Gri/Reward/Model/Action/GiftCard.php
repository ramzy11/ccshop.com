 ...
 */
class Gri_Reward_Model_Action_Giftcard extends Gri_Reward_Model_Action_Abstract
{
    ...
    public function getHistoryMessage($args = array())
    {
        ...
        return Mage::helper('gri_reward')->__('Redeemed for GiftCard id #%s.', $incrementId);
    }
    ...
    public function setEntity($entity)
    {
        ...
        $this->getHistory()->addAdditionalData(array(
            'increment_id' => $this->getEntity()->getId()
        ));
        return $this;
    }
}
