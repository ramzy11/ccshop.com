...
class AW_Rma_Block_Customer_Dashboard extends Mage_Core_Block_Template {
    ...
    protected function _prepareLayout() {
        ...
        $this->getLayout()->getBlock('head')->setTitle($this->__('Return / Exchange'));
        ...
        $breadcrumbs->addCrumb('return-exchange', array('label' => $this->__('Return or Exchange'), 'title' => $this->__('Return or Exchange')));

        parent::_prepareLayout();
        $pager = $this->getLayout()->createBlock('page/html_pager', 'awrma.entity.list.pager')->setCollection($this->getRmaEntitiesCollection());
