...
/**
 * Gri cms page config model
 *
 * @category    Gri
 * @package     Gri_Cms
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Gri_Cms_Model_Config
{
    ...
    public function getAllowedAccessLevel()
    {
        if ($this->canCurrentUserPublishRevision()) {
            return array(
                ...
                Gri_Cms_Model_Page_Version::ACCESS_LEVEL_PUBLIC
                );
        } else {
            return array(Gri_Cms_Model_Page_Version::ACCESS_LEVEL_PUBLIC);
        }
    }
