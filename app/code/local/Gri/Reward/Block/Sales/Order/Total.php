 ...
 */
class Gri_Reward_Block_Sales_Order_Total extends Mage_Core_Block_Template
{
    /**
     ...
     *
     * @return Gri_Reward_Block_Sales_Order_Total
     */
    public function initTotals()
    {
        if ((float) $this->getOrder()->getBaseRewardCurrencyAmount()) {
            ...
            $this->getParentBlock()->addTotal(new Varien_Object(array(
                'code'   => 'reward_points',
                'strong' => false,
                'label'  => Mage::helper('gri_reward')->formatReward($source->getRewardPointsBalance()),
