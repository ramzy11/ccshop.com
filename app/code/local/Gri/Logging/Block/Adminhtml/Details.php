 ...
 * Log grid container
 */
class Gri_Logging_Block_Adminhtml_Details extends Mage_Adminhtml_Block_Widget_Container
{
    /**
     * Store curent event
     *
     * @var Gri_Logging_Model_Event
     */
    ...
    public function __construct()
    {
        ...
        $this->_addButton('back', array(
            'label'   => Mage::helper('gri_logging')->__('Back'),
    ...
    public function getHeaderText()
    {
        if ($this->getCurrentEvent()) {
            return Mage::helper('gri_logging')->__('Log Entry #%d', $this->getCurrentEvent()->getId());
        }
        return Mage::helper('gri_logging')->__('Log Entry Details');
    }

    /**
     * Get current event
     *
     * @return Gri_Logging_Model_Event|null
     */
