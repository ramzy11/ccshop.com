 ...
 */
class Gri_Reward_Model_Mysql4_Reward_Rate extends Mage_Core_Model_Mysql4_Abstract
{
    /**
    ...
    {
        $this->_init('gri_reward/reward_rate', 'rate_id');
    }

    /**
     * Fetch rate customer group and website
     *
     * @param Gri_Reward_Model_Reward_Rate $rate
     * @param integer $customerId
     * @param integer $websiteId
     * @return Gri_Reward_Model_Mysql4_Reward_Rate
     */
    public function fetch(Gri_Reward_Model_Reward_Rate $rate, $customerGroupId, $websiteId, $direction)
    {
