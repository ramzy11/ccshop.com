...
class Gri_Customer_AccountController extends Mage_Customer_AccountController
{
    /**
     ...
     * @var array
     */
    protected $_cookieCheckActions = array('loginPost', 'createpost','rebindpost');
    ...
    protected function _welcomeCustomer(Mage_Customer_Model_Customer $customer, $isJustConfirmed = false)
    {
		...
		/*Tracking code */
		$this->_getSession()->addSuccess($this->__('<iframe src="https://4383026.fls.doubleclick.net/activityi;src=4383026;type=signi037;cat=ccsho359;ord=%d?" width="1" height="1" frameborder="0" style="display:none"></iframe>', time()));
