...
class Bcnet_RestApi_Model_Result extends Bcnet_RestApi_Model_Abstract {
    ...
    const ERROR_0x0019 = 'Invalid App Key';
    const ERROR_0x1000 = '';
    ...
    const ERROR_0x1012 = 'This email address has been subscribed(User)';
    ...
    {
		if (isset($arrayitem[0]) && is_array($arrayitem[0])) {
			$results = array();
