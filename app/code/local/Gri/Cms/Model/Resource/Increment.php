 ...
 */
class Gri_Cms_Model_Resource_Increment extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
    ...
    {
        $this->_init('gri_cms/increment', 'increment_id');
    }
...
*/
     ...
     * @param int $node
     * @param int $level
     * @return Gri_Cms_Model_Resource_Increment
     */
