 ...
 */
class Gri_Sales_Block_Order_Totals extends Mage_Sales_Block_Order_Totals
{
    /**
     * Initialize order totals array
     *
     * @return Gri_Sales_Block_Order_Totals
     */
    protected function _initTotals()
    {
        ...
        if (!$source->getIsVirtual() && ((float) $source->getShippingAmount() || $source->getShippingDescription()))
        {
            $this->_totals['shipping'] = new Varien_Object(array(
                ...
                'description' => $source->getShippingMethod()
            ));
        }
        ...
        if (((float)$this->getSource()->getDiscountAmount()) != 0) {
            if ($this->getSource()->getDiscountDescription()) {
                ...
                //  $discountLabel = $this->__('Discount & Discount');
            }
            ...
            $this->_totals['discount'] = new Varien_Object(array(
                ...
                'description' =>  $source->getDiscountDescription()
            ));
        }
