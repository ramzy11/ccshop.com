...
$installer->getConnection()->addColumn($installer->getTable('gri_cms_widget_instance'), 'store_ids', 'varchar(255) NOT NULL default \'0\'');
$installer->getConnection()->addColumn($installer->getTable('gri_cms_widget_instance'), 'widget_parameters', 'text');
$installer->run("
