...
$widgetInstanceOldExists = $installer->tableExists($installer->getTable('gri_cms_widget_instance'));
$widgetInstancePageOldExists = $installer->tableExists($installer->getTable('gri_cms_widget_instance_page'));
$widgetInstancePageLayoutOldExists = $installer->tableExists($installer->getTable('gri_cms_widget_instance_page_layout'));
...
if ($widgetInstanceOldExists && $widgetInstancePageOldExists && $widgetInstancePageLayoutOldExists) {
    ...
    $select = $conn->select()
        ->from($installer->getTable('gri_cms_widget_instance'))
    ...
    if (!empty($widgetInstanceData)) {
        ...
        $select = $conn->select()
            ->from($installer->getTable('gri_cms_widget_instance_page'))
    ...
    if (!empty($pageData)) {
        ...
        $select = $conn->select()
            ->from($installer->getTable('gri_cms_widget_instance_page_layout'))
    ...
    $installer->run("
        DROP TABLE IF EXISTS `{$installer->getTable('gri_cms_widget_instance')}`;
        DROP TABLE IF EXISTS `{$installer->getTable('gri_cms_widget_instance_page')}`;
        DROP TABLE IF EXISTS `{$installer->getTable('gri_cms_widget_instance_page_layout')}`;
    ");
}
