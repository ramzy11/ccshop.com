 ...
 */
class Gri_CatalogCustom_Block_Adminhtml_Editorpick_Edit extends Mage_Adminhtml_Block_Widget
{
    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('catalogcustom/product/editorpick/edit.phtml');
