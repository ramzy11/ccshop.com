 ...
 *
 */
class Gri_Logging_Block_Adminhtml_Archive_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
    ...
    {
        $this->setCollection(Mage::getSingleton('gri_logging/archive_collection'));
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('download', array(
            'header'    => Mage::helper('gri_logging')->__('Archive File'),
            'format'    => '<a href="' . $downloadUrl .'basename/$basename/">$basename</a>',
            'index'     => 'basename',
        ));

        $this->addColumn('date', array(
            'header'    => Mage::helper('gri_logging')->__('Date'),
            'type'      => 'date',
            'index'     => 'time',
            'filter'    => 'gri_logging/adminhtml_archive_grid_filter_date'
        ));
