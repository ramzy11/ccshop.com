 ...
 */
class Gri_Logging_Adminhtml_LoggingController extends Mage_Adminhtml_Controller_Action
{
    /**
     * Log page
     */
    public function indexAction()
    {
        ...
        $this->loadLayout();
        $this->_setActiveMenu('system/gri_logging');
        $this->renderLayout();
    }
    ...
    public function detailsAction()
    {
        ...
        $model   = Mage::getModel('gri_logging/event')
            ->load($eventId);
        if (!$model->getId()) {
            $this->_redirect('*/*/');
            return;
    ...
    public function exportCsvAction()
    {
        $this->_prepareDownloadResponse('log.csv',
            $this->getLayout()->createBlock('gri_logging/adminhtml_index_grid')->getCsvFile()
        );
    }
    ...
    public function exportXmlAction()
    {
        $this->_prepareDownloadResponse('log.xml',
            $this->getLayout()->createBlock('gri_logging/adminhtml_index_grid')->getExcelFile()
        );
    }
    ...
    {
        $archive = Mage::getModel('gri_logging/archive')->loadByBaseName(
    ...
    protected function _isAllowed()
    {
        switch ($this->getRequest()->getActionName()) {
            ...
            case 'download':
            case 'archiveGrid':
                return Mage::getSingleton('admin/session')->isAllowed('admin/system/gri_logging/backups');
                break;
            case 'grid':
            case 'exportCsv':
            case 'exportXml':
            case 'details':
            case 'index':
                return Mage::getSingleton('admin/session')->isAllowed('admin/system/gri_logging/events');
                break;
        }
