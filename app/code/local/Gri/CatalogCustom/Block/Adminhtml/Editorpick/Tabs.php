...
*/
class Gri_CatalogCustom_Block_Adminhtml_Editorpick_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
	...
	protected function _beforeToHtml()
	{
		$this->addTab('form_section', array(
			...
			'content'   => $this->getLayout()->createBlock('gri_catalogcustom/adminhtml_editorpick_tab_form')->toHtml(),
		));
		$_GET['active_tab'] = 'form_section';
		$this->removeTab('configurable');
		$this->removeTab('super');
