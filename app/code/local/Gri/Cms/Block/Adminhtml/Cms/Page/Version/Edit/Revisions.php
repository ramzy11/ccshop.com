...
class Gri_Cms_Block_Adminhtml_Cms_Page_Version_Edit_Revisions
    extends Mage_Adminhtml_Block_Widget_Grid
{
     ...
     *
     * @return Gri_Cms_Block_Adminhtml_Cms_Page_Version_Edit_Revisions
     */
     ...
     *
     * @return Gri_Cms_Model_Mysql4_Page_Version_Collection
     */
...
*/
        $this->addColumn('revision_number', array(
            'header' => Mage::helper('gri_cms')->__('Revision #'),
            'width' => 200,
            'type' => 'number',
        ...
        $this->addColumn('created_at', array(
            'header' => Mage::helper('gri_cms')->__('Created'),
            'index' => 'created_at',
            'type' => 'datetime',
            'filter_time' => true,
            'width' => 250
        ...
        $this->addColumn('author', array(
            'header' => Mage::helper('gri_cms')->__('Author'),
            'index' => 'user',
            'type' => 'options',
    ...
    {
        if (Mage::getSingleton('gri_cms/config')->canCurrentUserDeleteRevision()) {
