...
class Gri_GiftCardAccount_Block_Adminhtml_Giftcardaccount_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function __construct()
    {
        ...
        $this->_blockGroup = 'gri_giftcardaccount';
        ...
        $this->_updateButton('save', 'label', Mage::helper('gri_giftcardaccount')->__('Save'));
        $this->_updateButton('save', 'onclick', $clickSave);
        $this->_updateButton('delete', 'label', Mage::helper('gri_giftcardaccount')->__('Delete'));
        ...
        $this->_addButton('send', array(
            'label'     => Mage::helper('gri_giftcardaccount')->__('Save & Send Email'),
            'onclick'   => $clickSend,
            'class'     => 'save',
        ));
    }
    ...
    public function getHeaderText()
    {
        if (Mage::registry('current_giftcardaccount')->getId()) {
            return Mage::helper('gri_giftcardaccount')->__('Edit Gift Card Account: %s', $this->htmlEscape(Mage::registry('current_giftcardaccount')->getCode()));
        }
        else {
            return Mage::helper('gri_giftcardaccount')->__('New Gift Card Account');
        }
    }
