 ...
 */
class Gri_Reward_Model_Source_Points_InvitationOrder
{
    public function toOptionArray()
    {
        return array(
            array('value' => '*', 'label' => Mage::helper('gri_reward')->__('Each')),
            array('value' => '1', 'label' => Mage::helper('gri_reward')->__('First')),
        );
    }
}
