 ...
 * @package    Gri_Cms
 */
class Gri_Cms_Block_Hierarchy_Pagination extends Mage_Core_Block_Template
{
    /**
     * Current Hierarchy Node Page Instance
     *
     * @var Gri_Cms_Model_Hierarchy_Node
     */
    protected $_node;
    ...
    protected function _construct()
    {
        ...
        if ($this->getNodeId()) {
            $this->_node = Mage::getModel('gri_cms/hierarchy_node')
                ->load($this->getNodeId());
        } else {
    ...
    protected function _loadNodePaginationParams()
    {
        ...
        if ($this->_node instanceof Mage_Core_Model_Abstract) {
            ...
            if ($params !== null
                ...
                && $params['pager_visibility'] == Gri_Cms_Helper_Hierarchy::METADATA_VISIBILITY_YES)
            {
                $this->addData(array(
     ...
     * @return string
     */
    public function getNodeLabel(Gri_Cms_Model_Hierarchy_Node $node, $custom = null)
    {
