 ...
 */
class Gri_Reward_Helper_Data extends Mage_Core_Helper_Abstract
{
    /**
     * XML configuration paths
     */
    const XML_PATH_SECTION_GENERAL = 'gri_reward/general/';
    const XML_PATH_SECTION_POINTS = 'gri_reward/points/';
    const XML_PATH_SECTION_NOTIFICATIONS = 'gri_reward/notification/';
    const XML_PATH_ENABLED = 'gri_reward/general/is_enabled';
    const XML_PATH_LANDING_PAGE = 'gri_reward/general/landing_page';
    const XML_PATH_AUTO_REFUND = 'gri_reward/general/refund_automatically';
    ...
    public function isOrderAllowed($websiteId = null)
    {
        ...
        return $allowed = (bool)(int)Mage::helper('gri_reward')->getPointsConfig('order', $websiteId);
    }
    ...
    {
        $ratesArray = array();
        $collection = Mage::getModel('gri_reward/reward_rate')->getCollection()
            ->addFieldToFilter('direction', Gri_Reward_Model_Reward_Rate::RATE_EXCHANGE_DIRECTION_TO_CURRENCY);
