...
$installer = $this;
/**
 * Create table 'gri_logging/event'
 */
$table = $installer->getConnection()
    ->newTable($installer->getTable('gri_logging/event'))
    ...
    ->addIndex($installer->getIdxName('gri_logging/event', array('user_id')),
        array('user_id'))
    ->addIndex($installer->getIdxName('gri_logging/event', array('user')),
        array('user'))
    ->addForeignKey($installer->getFkName('gri_logging/event', 'user_id', 'admin/user', 'user_id'),
        'user_id', $installer->getTable('admin/user'), 'user_id',
        Varien_Db_Ddl_Table::ACTION_SET_NULL, Varien_Db_Ddl_Table::ACTION_CASCADE)
    ->setComment('Gri Logging Event');
$installer->getConnection()->createTable($table);

/**
 * Create table 'gri_logging/event_changes'
 */
$table = $installer->getConnection()
    ->newTable($installer->getTable('gri_logging/event_changes'))
    ...
    ->addIndex($installer->getIdxName('gri_logging/event_changes', array('event_id')),
        array('event_id'))
    ->addForeignKey($installer->getFkName('gri_logging/event_changes', 'event_id', 'gri_logging/event', 'log_id'),
        'event_id', $installer->getTable('gri_logging/event'), 'log_id',
        Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
    ->setComment('Gri Logging Event Changes');
$installer->getConnection()->createTable($table);
