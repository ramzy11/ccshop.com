 ...
 * @package    Gri_Cms
 */
class Gri_Cms_Block_Adminhtml_Cms_Hierarchy_Widget_Radio extends Mage_Adminhtml_Block_Template
{
    /**
     * Unique Hash Id
     *
     ...
     * @var string
     */
    protected $_template = 'gri/cms/hierarchy/widget/radio.phtml';
    ...
    {
        if ($nodeId) {
            $node = Mage::getSingleton('gri_cms/hierarchy_node')->load($nodeId);
            if ($node->getId()) {
