 ...
 * @package    Gri_CustomerBalance
 */
class Gri_CustomerBalance_Block_Checkout_Onepage_Payment_Additional extends Mage_Core_Block_Template
{
    /**
    ...
    protected function _getBalanceModel()
    {
        if (is_null($this->_balanceModel)) {
            $this->_balanceModel = Mage::getModel('gri_customerbalance/balance')
