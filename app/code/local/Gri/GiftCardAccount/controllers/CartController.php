...
class Gri_GiftCardAccount_CartController extends Mage_Core_Controller_Front_Action
{
    /**
    ...
    public function addAction()
    {
        ...
        if (isset($data['giftcard_code'])) {
            ...
            try {
                ...
                Mage::dispatchEvent('gri_giftcardaccount_add', array('status' => 'fail', 'code' => $code));
    ...
    {
        /* @var $card Gri_GiftCardAccount_Model_Giftcardaccount */
        $card = Mage::getModel('gri_giftcardaccount/giftcardaccount')
