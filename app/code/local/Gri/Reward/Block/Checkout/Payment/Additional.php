 ...
 */
class Gri_Reward_Block_Checkout_Payment_Additional extends Mage_Core_Block_Template
{
    /**
     * Getter
     *
    ...
    {
//        if (!Mage::helper('gri_reward')->getHasRates()
//            || !Mage::helper('gri_reward')->isEnabledOnFront()) {
//            return false;
//        }
//        $minPointsToUse = Mage::helper('gri_reward')
...
//        return (boolean)(((float)$this->getCurrencyAmount() > 0) && $canUseRewadPoints);
          ...
          //  reward points  is  only purchased  gifts  
          return   false ;
    }
