...
$versionTableOld = $installer->getTable('gri_cms_version');
$revisionTableOld = $installer->getTable('gri_cms_revision');

$versionTableNew = $installer->getTable('gri_cms/page_version');
$revisionTableNew = $installer->getTable('gri_cms/page_revision');

$incrementTable = $installer->getTable('gri_cms/increment');
