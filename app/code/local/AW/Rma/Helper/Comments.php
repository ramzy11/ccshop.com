...
class AW_Rma_Helper_Comments extends Mage_Core_Helper_Abstract {
     ...
     * @return boolean
     */
    public static function saveComment($request, $guestMode = FALSE, $addSuccess = TRUE) {
        $_okFlag = TRUE;
            ...
            if (!in_array($_rmaRequest->getStatus(), Mage::helper('awrma/status')->getResolvedStatuses())) {
                ...
                if ($_data['text']) {
                    ...
                    if ($_okFlag) {
                        ...
                        $addSuccess and self::_getSession()->addSuccess(Mage::helper('awrma')->__('Comment successfully added'));
