 ...
 */
class Gri_Customer_Block_Account_Dashboard extends Mage_Customer_Block_Account_Dashboard
{
    protected function _prepareLayout()
    {
        ...
        $breadcrumbs->addCrumb('dashboard', array('label' => $this->__('Dashboard'), 'title' => $this->__('Dashboard')));
