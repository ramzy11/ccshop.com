 ...
 */
class Gri_Reward_Block_Adminhtml_Reward_Rate_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
    ...
    public function getHeaderText()
    {
        if (Mage::registry('current_reward_rate')->getId()) {
            return Mage::helper('gri_reward')->__('Edit Reward Exchange Rate');
        } else {
            return Mage::helper('gri_reward')->__('New Reward Exchange Rate');
        }
    }
