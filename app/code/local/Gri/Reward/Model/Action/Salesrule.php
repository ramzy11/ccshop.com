 ...
 */
class Gri_Reward_Model_Action_Salesrule extends Gri_Reward_Model_Action_Abstract
{
     /**
    ...
    public function getPoints($websiteId) {
        ...
        if ($this->_quote) {
            ...
            if ($this->_quote->getAppliedRuleIds()) { 
                ...
                $data = Mage::getResourceModel('gri_reward/reward')->getRewardSalesrule($ruleIds);
    ...
    public function getHistoryMessage($args = array())
    {
        ...
        return Mage::helper('gri_reward')->__('Earned promotion extra points from order #%s.', $incrementId);
    }
