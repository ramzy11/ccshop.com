...
class Gri_Cms_Block_Adminhtml_Cms_Page extends Mage_Adminhtml_Block_Template
{
    /**
     * Add  column Versioned to cms page grid
     *
     * @return Gri_Cms_Block_Adminhtml_Cms_Page
     */
        ...
        if ($page) {
            ...
            if($pageGrid) {
                $pageGrid->addColumnAfter('versioned', array(
                    ...
                    'header'    => Mage::helper('gri_cms')->__('Version Control'),
                    'width'     => 10,
                    'type'      => 'options',
                    'options'   => array(Mage::helper('gri_cms')->__('No'),
                        Mage::helper('gri_cms')->__('Yes')
                    )
                ), 'page_actions');
            }
        }
