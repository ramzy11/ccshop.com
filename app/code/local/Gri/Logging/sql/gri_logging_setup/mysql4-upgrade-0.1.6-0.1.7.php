...
$installer->run("DELETE FROM {$installer->getTable('core_config_data')} WHERE `path` LIKE 'admin/gri_logging/%'");
$installer->getConnection()->changeColumn($installer->getTable('gri_logging/event'),
