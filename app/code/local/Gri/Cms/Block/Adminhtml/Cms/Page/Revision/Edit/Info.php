...
class Gri_Cms_Block_Adminhtml_Cms_Page_Revision_Edit_Info extends Mage_Adminhtml_Block_Widget_Container
{
    /**
    ...
    public function getVersion()
    {
        ...
        return $version ? $version : Mage::helper('gri_cms')->__('N/A');
    }
    ...
    public function getAuthor()
    {
        ...
        return Mage::helper('gri_cms')->__('N/A');
    }
    ...
    public function getCreatedAt()
    {
        ...
        try {
            ...
            $data = Mage::helper('gri_cms')->__('N/A');
        }
        return  $data;
    }
}
