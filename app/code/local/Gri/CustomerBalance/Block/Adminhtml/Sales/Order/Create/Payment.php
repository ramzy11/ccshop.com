 ...
 *
 */
class Gri_CustomerBalance_Block_Adminhtml_Sales_Order_Create_Payment
extends Mage_Core_Block_Template
{
    /**
     * @var Gri_CustomerBalance_Model_Balance
     */
    ...
    {
        if (!Mage::helper('gri_customerbalance')->isEnabled() || !$this->_getBalanceInstance()) {
            return 0.0;
        }
     ...
     *
     * @return Gri_CustomerBalance_Model_Balance|false
     */
    protected function _getBalanceInstance()
    {
        if (!$this->_balanceInstance) {
            ...
            $this->_balanceInstance = Mage::getModel('gri_customerbalance/balance')
