...
class Gri_Cms_Helper_Data extends Mage_Core_Helper_Abstract
{
    /**
    ...
    {
        return array(
            Gri_Cms_Model_Page_Version::ACCESS_LEVEL_PRIVATE => $this->__('Private'),
            Gri_Cms_Model_Page_Version::ACCESS_LEVEL_PROTECTED => $this->__('Protected'),
            Gri_Cms_Model_Page_Version::ACCESS_LEVEL_PUBLIC => $this->__('Public')
        );
    }
