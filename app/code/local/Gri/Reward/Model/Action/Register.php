 ...
 */
class Gri_Reward_Model_Action_Register extends Gri_Reward_Model_Action_Abstract
{
    /**
    ...
    {
        return (int)Mage::helper('gri_reward')->getPointsConfig('register', $websiteId);
    }
    ...
    {
        return Mage::helper('gri_reward')->__('Registered as customer.');
    }
}
