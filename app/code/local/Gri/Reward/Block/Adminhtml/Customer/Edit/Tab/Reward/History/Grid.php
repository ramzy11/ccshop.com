 ...
 */
class Gri_Reward_Block_Adminhtml_Customer_Edit_Tab_Reward_History_Grid
    extends Mage_Adminhtml_Block_Widget_Grid
{
     ...
     *
     * @return Gri_Reward_Block_Adminhtml_Customer_Edit_Tab_Reward_History_Grid
     */
    protected function _prepareCollection()
    {
        /* @var $collection Gri_Reward_Model_Mysql4_Reward_History_Collection */
        $collection = Mage::getModel('gri_reward/reward_history')->getCollection()
    ...
    protected function _prepareColumns()
    {
        $this->addColumn('points_balance', array(
            ...
            'header'   => Mage::helper('gri_reward')->__('Balance'),
            'sortable' => false,
            'filter'   => false,
            'width'    => 1,
        ));
        ...
        $this->addColumn('currency_amount', array(
            ...
            'header'   => Mage::helper('gri_reward')->__('Amount Balance'),
            'sortable' => false,
            'filter'   => false,
            'width'    => 1,
        ));
        ...
        $this->addColumn('points_delta', array(
            'type'     => 'number',
            'index'    => 'points_delta',
            'header'   => Mage::helper('gri_reward')->__('Points'),
            'sortable' => false,
            'filter'   => false,
        ...
        $this->addColumn('currency_delta', array(
            ...
            'header'   => Mage::helper('gri_reward')->__('Amount'),
            'sortable' => false,
            'filter'   => false,
            'show_number_sign' => true,
            'width'    => 1,
        ...
        $this->addColumn('rate', array(
            'getter' => 'getRateText',
            'header'   => Mage::helper('gri_reward')->__('Rate'),
            'sortable' => false,
            'filter'   => false
        ));
...
// TODO: instead of source models move options to a getter
        $this->addColumn('website', array(
            'type'     => 'options',
            'options'  => Mage::getModel('gri_reward/source_website')->toOptionArray(false),
            'index'    => 'website_id',
            'header'   => Mage::helper('gri_reward')->__('Website'),
            'sortable' => false,
        ));
...
// TODO: custom renderer for reason, which includes comments
        $this->addColumn('message', array(
            ...
            'type'     => 'text',
            'getter'   => 'getMessage',
            'header'   => Mage::helper('gri_reward')->__('Reason'),
            'sortable' => false,
            'filter'   => false,
            'renderer' => 'gri_reward/adminhtml_customer_edit_tab_reward_history_grid_column_renderer_reason',
        ));

        $this->addColumn('created_at', array(
            'type'     => 'datetime',
            'index'    => 'created_at',
            'header'   => Mage::helper('gri_reward')->__('Created At'),
            'sortable' => false,
            'align'    => 'left',
        ...
        $this->addColumn('expiration_date', array(
            'type'     => 'datetime',
            'getter'   => 'getExpiresAt',
            'header'   => Mage::helper('gri_reward')->__('Expires At'),
            'sortable' => false,
...
// TODO: merge with reason
        $this->addColumn('comment', array(
            'index'    => 'comment',
            'header'   => Mage::helper('gri_reward')->__('Comment'),
            'sortable' => false,
            'filter'   => false,
            'align'    => 'left',
        ));
     ...
     * Return grid row url
     *
     * @param Gri_Reward_Model_Reward_History $row
     * @return string
     */
