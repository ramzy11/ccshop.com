...
class Magestore_Promotionalgift_Block_Product_View extends Mage_Catalog_Block_Product_View
{
    ...
    public function getUrlImage() {
        // $config = Mage::helper('promotionalgift')->getBaseUrlImage();
        // if ($config) {
            // $imgSrc = Mage::getBaseUrl('media') . 'promotionalgift/animation/' . $config;
            // return $imgSrc;
        // } else {
    ...
    // public function getAutoScroll() {
        // return Mage::helper('promotionalgift')->getConfig('auto_scroll');
    // }
