...
class Gri_Cms_Block_Adminhtml_Cms_Page_Revision_Edit_Tab_Content
    extends Mage_Adminhtml_Block_Cms_Page_Edit_Tab_Content
{
     ...
     *
     * @return Gri_Cms_Block_Adminhtml_Cms_Page_Revision_Edit_Tab_Content
     */
    protected function _prepareForm()
    {
        ...
        Mage::helper('gri_cms')->addOnChangeToFormElements($this->getForm(), 'dataChanged();');
