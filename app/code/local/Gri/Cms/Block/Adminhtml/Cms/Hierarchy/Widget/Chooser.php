 ...
 *
 * @method Gri_Cms_Block_Adminhtml_Cms_Hierarchy_Widget_Chooser setScope(string $value)
 * @method Gri_Cms_Block_Adminhtml_Cms_Hierarchy_Widget_Chooser setScopeId(int $value)
 *
 * @category   Gri
 * @package    Gri_Cms
 */
class Gri_Cms_Block_Adminhtml_Cms_Hierarchy_Widget_Chooser extends Mage_Adminhtml_Block_Template
{
    /**
    ...
    public function prepareElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        if ($element->getValue()) {
            $node = Mage::getModel('gri_cms/hierarchy_node')->load($element->getValue());
            if ($node->getId()) {
                $chooser->setLabel($node->getLabel());
            }
        }

        $radioHtml = Mage::getBlockSingleton('gri_cms/adminhtml_cms_hierarchy_widget_radio')
            ->setUniqId($uniqueId)
            ->toHtml();
    ...
    {
        $nodes = array();
        /** @var $hierarchyNode Gri_Cms_Model_Hierarchy_Node */
        $hierarchyNode = Mage::getModel('gri_cms/hierarchy_node');
