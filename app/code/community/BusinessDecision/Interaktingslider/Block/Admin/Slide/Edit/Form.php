...
class BusinessDecision_Interaktingslider_Block_Admin_Slide_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('group', 'text', array(
            'name'      => 'group',
            'label'     => Mage::helper('interaktingslider')->__('Group'),
            'title'     => Mage::helper('interaktingslider')->__('Group'),
            'required'  => true,
        ));
		 ...
		 */
        $model->getFromTime() and $model->setFromTime(Mage::app()->getLocale()->date($model->getFromTime(), Varien_Date::DATETIME_INTERNAL_FORMAT));
		 ...
		 */
        $model->getToTime() and $model->setToTime(Mage::app()->getLocale()->date($model->getToTime(), Varien_Date::DATETIME_INTERNAL_FORMAT));
