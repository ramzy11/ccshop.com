...
//                                    Mage::helper('awrma/comments')->postComment($rmaEntity->getId(), $request->getParam('additionalinfo'), $_data, FALSE);
                                    $request->setParam('comment', $request->getParam('additionalinfo'))
                                        ->setParam('id', $rmaEntity->getId());
                                    Mage::helper('awrma/comments')->saveComment($request, FALSE, FALSE);
                                }
