 ...
 */
class Gri_Cms_Block_Adminhtml_Scope_Switcher extends Mage_Adminhtml_Block_System_Config_Switcher
{
    /**
    ...
    public function getStoreSelectOptions()
    {
        if (is_null($this->_options)) {
            ...
            $this->_options['default']['label'] = Mage::helper('gri_cms')->__('All Store Views');
        }
