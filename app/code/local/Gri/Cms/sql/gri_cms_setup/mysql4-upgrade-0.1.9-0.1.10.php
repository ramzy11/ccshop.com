...
$hierarchyTable = $installer->getTable('gri_cms_hierarchy');
$metadataTable = $installer->getTable('gri_cms/hierarchy_metadata');
$nodeTable = $installer->getTable('gri_cms/hierarchy_node');
