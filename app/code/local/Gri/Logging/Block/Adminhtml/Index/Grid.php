 ...
 */
class Gri_Logging_Block_Adminhtml_Index_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Constructor
     */
    ...
    {
        $this->setCollection(Mage::getResourceModel('gri_logging/event_collection'));
     ...
     *
     * @return Gri_Logging_Block_Adminhtml_Index_Grid
     */
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('event', array(
            ...
            'type'      => 'options',
            'sortable'  => false,
            'options'   => Mage::getSingleton('gri_logging/config')->getLabels(),
        ));

        $actions = array();
        foreach (Mage::getResourceSingleton('gri_logging/event')->getAllFieldValues('action') as $action) {
            $actions[$action] = Mage::helper('gri_logging')->getLoggingActionTranslatedLabel($action);
        }
        ...
        $this->addColumn('ip', array(
            ...
            'index'     => 'ip',
            'type'      => 'text',
            'filter'    => 'gri_logging/adminhtml_grid_filter_ip',
        ...
        $this->addColumn('user', array(
            ...
            'escape'    => true,
            'sortable'  => false,
            'filter'    => 'gri_logging/adminhtml_grid_filter_user',
            'width'     => 150,
        ));
        ...
        $this->addColumn('status', array(
            ...
            'type'      => 'options',
            'options'   => array(
                Gri_Logging_Model_Event::RESULT_SUCCESS => $this->__('Success'),
                Gri_Logging_Model_Event::RESULT_FAILURE => $this->__('Failure'),
            ),
            'width'     => 100,
        ));
        ...
        $this->addColumn('info', array(
            ...
            'renderer'  => 'gri_logging/adminhtml_grid_renderer_details',
            'width'     => 100,
        ));
