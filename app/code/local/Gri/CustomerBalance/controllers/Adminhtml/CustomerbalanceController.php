 ...
 *
 */
class Gri_CustomerBalance_Adminhtml_CustomerbalanceController extends Mage_Adminhtml_Controller_Action
{
    /**
     * Check is enabled module in config
     *
     * @return Gri_CatalogEvent_Adminhtml_Catalog_EventController
     */
    ...
    public function gridHistoryAction()
    {
        ...
        $this->getResponse()->setBody(
            $this->getLayout()->createBlock('gri_customerbalance/adminhtml_customer_edit_tab_customerbalance_balance_history_grid')->toHtml()
        );
    }
    ...
    {
        $balance = Mage::getSingleton('gri_customerbalance/balance')->deleteBalancesByCustomerId(
    ...
    protected function _initCustomer($idFieldName = 'id')
    {
        ...
        if (!$customer->getId()) {
            Mage::throwException(Mage::helper('gri_customerbalance')->__('Failed to initialize customer'));
        }
