...
class Gri_Reports_Block_Adminhtml_Sales_Coupon_Details_Form extends Mage_Adminhtml_Block_Report_Filter_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('used', 'select', array(
            'name' => 'used',
            'options' => array(
                '' => Mage::helper('reports')->__('Any'),
                '1' => Mage::helper('reports')->__('Yes'),
                '2' => Mage::helper('reports')->__('No')
            ),
            'label' => Mage::helper('reports')->__('Used'),
            'title' => Mage::helper('reports')->__('Used')
        ));
        return $this;
    }
}
