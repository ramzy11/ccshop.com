 ...
 */
class Gri_ImportData_Model_Convert_Adapter_ProductAttributesimport extends Mage_Catalog_Model_Convert_Adapter_Product {
    ...
    public function saveRow(array $importData) {
        ...
        if ($attribute_exists->getId() == "") {
            ...
            if ($importData['attribute_options'] != "") {
                ...
                foreach ($pipedelimiteddata as $attribute_options_data) {
                    ...
                    foreach ($pipedelimiteddatabycomma as $options_data) {
                        ...
                        //0 is the admin value, 1 is the "default store view" (frontend) value
                        $optionData['value']['option_' . $attributevaluecounter . ''][$actualattributeoptiondata[0]] = $actualattributeoptiondata[1];
            ...
            if ($importData["apply_to"] == 'all')
                $data['apply_to'] = 'simple,grouped,configurable,virtual,downloadable,bundle';
            else
            ...
            if ($importData['attribute_options'] != "") {
                ...
                $attribute_exists->setOption($optionData);
            }
