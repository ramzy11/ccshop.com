...
class Mana_Filters_Helper_Data extends Mage_Core_Helper_Abstract {
	...
	public function getFilterOptionsCollection($allCategories = false) {
	    ...
	    if (in_array($request->getModuleName(),array('catalogsearch','gri_catalogsearch')) && $request->getControllerName() == 'result' && $request->getActionName() == 'index' ||
    ...
    public function getLayer () {
        if (in_array(Mage::helper('mana_core')->getRoutePath(), array('gri_catalogsearch/result/index','catalogsearch/result/index', 'manapro_filterajax/search/index'))) {
