 ...
 */
class Gri_Logging_Model_Processor
{
    /**
    ...
    /**
     * Temporary storage for model changes before saving to gri_logging_event_changes table.
     *
     * @var array
     */
    ...
    {
        $this->_config = Mage::getSingleton('gri_logging/config');
        $this->_modelsHandler = Mage::getModel('gri_logging/handler_models');
        $this->_controllerActionsHandler = Mage::getModel('gri_logging/handler_controllers');
    }
    ...
    public function logAction()
    {
        ...
        $loggingEvent = Mage::getModel('gri_logging/event')->setData(array(
        ...
        if ($this->_actionName == 'denied') {
            ...
            $loggingEvent->setInfo(Mage::helper('gri_logging')->__('Access denied'));
     ...
     *
     * @param Gri_Logging_Model_Event_Changes $eventChange
     * @return Gri_Logging_Model_Processor
     */
