...
$installer->run("
CREATE TABLE `{$installer->getTable('gri_giftcardaccount/history')}` (
...
$installer->getConnection()->addConstraint(
    ...
    $installer->getTable('gri_giftcardaccount/history'), 'giftcardaccount_id',
    $installer->getTable('gri_giftcardaccount/giftcardaccount'), 'giftcardaccount_id'
);
