 ...
 */
class Gri_Reward_Model_Action_InvitationCustomer extends Gri_Reward_Model_Action_Abstract
{
    /**
    ...
    {
        return (int)Mage::helper('gri_reward')->getPointsConfig('invitation_customer', $websiteId);
    }
    ...
    public function canAddRewardPoints()
    {
        ...
        if ($invitation->getData('status') != Gri_Invitation_Model_Invitation::STATUS_ACCEPTED) {
            return false;
        }
    ...
    {
        return Mage::helper('gri_reward')->getPointsConfig('invitation_customer_limit', $this->getReward()->getWebsiteId());
    }
    ...
    public function getHistoryMessage($args = array())
    {
        ...
        return Mage::helper('gri_reward')->__('Invitation to %s converted into a customer.', $email);
    }
