 ...
 *
 */
class Gri_CustomerBalance_Block_Sales_Order_Customerbalance extends Mage_Core_Block_Template
{
    /**
     ...
     *
     * @return Gri_CustomerBalance_Block_Sales_Order_Customerbalance
     */
