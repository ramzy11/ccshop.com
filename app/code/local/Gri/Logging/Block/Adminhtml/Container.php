 ...
 */
class Gri_Logging_Block_Adminhtml_Container extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    /**
    ...
    {
        return Mage::helper('gri_logging')->__($this->getData('header_text'));
    }
     ...
     *
     * @deprecated after 1.6.0.0
     * @return object Gri_Logging_Model_Event
     */
