 ...
 */
class Gri_Reward_Model_Mysql4_Reward_History_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    ...
    protected function _joinReward()
    {
        ...
        $this->getSelect()->joinInner(
            array('reward_table' => $this->getTable('gri_reward/reward')),
