 ...
 *
 * @method Gri_Cms_Model_Resource_Hierarchy_Lock _getResource()
 * @method Gri_Cms_Model_Resource_Hierarchy_Lock getResource()
 * @method int getUserId()
 * @method Gri_Cms_Model_Hierarchy_Lock setUserId(int $value)
 * @method string getUserName()
 * @method Gri_Cms_Model_Hierarchy_Lock setUserName(string $value)
 * @method string getSessionId()
 * @method Gri_Cms_Model_Hierarchy_Lock setSessionId(string $value)
 * @method int getStartedAt()
 * @method Gri_Cms_Model_Hierarchy_Lock setStartedAt(int $value)
 *
 * @category    Gri
 * @package     Gri_Cms
 ...
 */
class Gri_Cms_Model_Hierarchy_Lock extends Mage_Core_Model_Abstract
{
    /**
    ...
    {
        $this->_init('gri_cms/hierarchy_lock');
    }
