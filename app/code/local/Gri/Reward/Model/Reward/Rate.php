 ...
 */
class Gri_Reward_Model_Reward_Rate extends Mage_Core_Model_Abstract
{
    ...
    public static function getRateText($direction, $points, $amount, $currencyCode = null)
    {
        switch ($direction) {
            case self::RATE_EXCHANGE_DIRECTION_TO_CURRENCY:
                return Mage::helper('gri_reward')->formatRateToCurrency($points, $amount, $currencyCode);
            case self::RATE_EXCHANGE_DIRECTION_TO_POINTS:
                return Mage::helper('gri_reward')->formatRateToPoints($points, $amount, $currencyCode);
        }
    }
    ...
    {
        $this->_init('gri_reward/reward_rate');
    }
    ...
    {
        $optArray = array(
            self::RATE_EXCHANGE_DIRECTION_TO_CURRENCY => Mage::helper('gri_reward')->__('Points to Currency'),
            self::RATE_EXCHANGE_DIRECTION_TO_POINTS => Mage::helper('gri_reward')->__('Currency to Points')
        );
        return $optArray;
    }
