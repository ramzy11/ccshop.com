 ...
 */
class Gri_Reward_Block_Customer_Account extends Mage_Core_Block_Abstract
{
    /**
     * Add RP link to tab if we have all rates
     *
     * @return Gri_Reward_Block_Customer_Account
     */
    protected function _prepareLayout()
    {
        parent::_prepareLayout();
        $navigationBlock = $this->getLayout()->getBlock('customer_account_navigation');
        if ($navigationBlock && Mage::helper('gri_reward')->isEnabledOnFront()) {
            $navigationBlock->addLink('gri_reward', 'gri_reward/customer/info/',
                Mage::helper('gri_reward')->__('Reward Points'));
        }
        return $this;
    }
}
