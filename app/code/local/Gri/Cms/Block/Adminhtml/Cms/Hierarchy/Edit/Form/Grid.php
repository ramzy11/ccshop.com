 ...
 * @package    Gri_Cms
 */
class Gri_Cms_Block_Adminhtml_Cms_Hierarchy_Edit_Form_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     ...
     *
     * @return Gri_Cms_Block_Adminhtml_Cms_Hierarchy_Edit_Tab_Pages_Grid
     */
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('page_id', array(
            'header'            => Mage::helper('gri_cms')->__('Page ID'),
            'sortable'          => true,
            'width'             => '60px',
            'type'              => 'range',
            'index'             => 'page_id'
        ...
        $this->addColumn('title', array(
            'header'            => Mage::helper('gri_cms')->__('Title'),
            'index'             => 'title',
            'column_css_class'  => 'label'
        ));

        $this->addColumn('identifier', array(
            'header'            => Mage::helper('gri_cms')->__('URL Key'),
            'index'             => 'identifier',
