...
class Gri_Api_Model_Api_HkAs400_Adapter_Rest extends Inchoo_Api_Model_Api_Server_Adapter_Json
{
    protected $_errors = array();
    protected $_faults;
    
    protected $_logFile = 'api.hkas400.server.success.log';

    protected $_logRequestJson = 'restPost.log';
    ...
    public function run()
    {
        ...
        Mage::log('Request JSON: ' .$request->getRawJson() , Zend_Log::DEBUG, $this->_logRequestJson);
