 ...
 */
class Gri_Reward_Block_Adminhtml_Customer_Edit_Tab_Reward_Management_Balance_Grid
    extends Mage_Adminhtml_Block_Widget_Grid
{
     ...
     *
     * @return Gri_Reward_Block_Adminhtml_Customer_Edit_Tab_Reward_Management_Balance_Grid
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('gri_reward/reward')
            ->getCollection()
    ...
    protected function _afterLoadCollection()
    {
        ...
        /* @var $item Gri_Reward_Model_Reward */
        foreach ($this->getCollection() as $item) {
            $website = $item->getData('website_id');
            if ($website !== null) {
                $minBalance = Mage::helper('gri_reward')->getGeneralConfig('min_points_balance', (int)$website);
                $maxBalance = Mage::helper('gri_reward')->getGeneralConfig('max_points_balance', (int)$website);
                $item->addData(array(
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('currency_amount', array(
            'header'   => Mage::helper('gri_reward')->__('Currency Amount'),
        ...
        $this->addColumn('min_balance', array(
            'header'   => Mage::helper('gri_reward')->__('Minimum Reward Points Balance to be able to Redeem'),
        ...
        $this->addColumn('max_balance', array(
            'header'   => Mage::helper('gri_reward')->__('Cap Reward Points Balance At'),
    ...
    protected function _afterToHtml($html)
    {
        ...
        if ($this->_customerHasOrphanPoints) {
            $deleteOrhanPointsButton = $this->getLayout()->createBlock('adminhtml/widget_button')->setData(array(
                'label'     => Mage::helper('gri_reward')->__('Delete Orphan Points'),
     ...
     * Return grid row url
     *
     * @param Gri_Reward_Model_Reward $row
     * @return string
     */
