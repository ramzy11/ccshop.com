 ...
 */
class Gri_Cms_Model_Resource_Page_Revision extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
    ...
    {
        $this->_init('gri_cms/page_revision', 'revision_id');

        $this->_pageTable         = $this->getTable('cms/page');
        $this->_versionTable      = $this->getTable('gri_cms/page_version');
     ...
     * @return Gri_Cms_Model_Resource_Page_Revision
     */
     ...
     *
     * @param Gri_Cms_Model_Page_Revision $object
     * @param int $targetId
     * @return Gri_Cms_Model_Resource_Page_Revision
     */
    public function publish(Gri_Cms_Model_Page_Revision $object, $targetId)
    {
