...
$installer->run("DROP TABLE IF EXISTS `{$this->getTable('gri_logging_user_log')}`");
$installer->getConnection()->addColumn($this->getTable('gri_logging/event'), 'status', "char(15) NOT NULL DEFAULT 'success'");
