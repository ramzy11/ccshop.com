 ...
 */
class Gri_Logging_Model_Config
{
    /**
    ...
    {
        $configXml = Mage::app()->loadCache('gri_logging_config');
        if ($configXml) {
            ...
            if (Mage::app()->useCache('config')) {
                Mage::app()->saveCache($config->getXmlString(), 'gri_logging_config',
    ...
    public function getSystemConfigValues()
    {
        if (null === $this->_systemConfigValues) {
            $this->_systemConfigValues = Mage::getStoreConfig('admin/gri_logging/actions');
            if (null === $this->_systemConfigValues) {
    ...
    public function getActionLabel($action)
    {
        ...
        $helper = $module ? Mage::helper($module) : Mage::helper('gri_logging');
