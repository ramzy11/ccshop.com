 ...
 */
class Gri_Reward_Model_Source_Points_ExpiryCalculation
{
    public function toOptionArray()
    {
        return array(
            array('value' => 'static', 'label' => Mage::helper('gri_reward')->__('Static')),
            array('value' => 'dynamic', 'label' => Mage::helper('gri_reward')->__('Dynamic')),
        );
    }
}
