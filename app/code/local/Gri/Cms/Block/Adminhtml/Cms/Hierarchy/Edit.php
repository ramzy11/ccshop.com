 ...
 * @package    Gri_Cms
 */
class Gri_Cms_Block_Adminhtml_Cms_Hierarchy_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->_addButton('delete', array(
            'label'     => Mage::helper('gri_cms')->__('Delete Current Hierarchy'),
            'class'     => 'delete',
        ...
        if (!Mage::app()->isSingleStoreMode()) {
            $this->_addButton('delete_multiple', array(
                'label'     => Mage::helper('gri_cms')->getDeleteMultipleHierarchiesText(),
                'class'     => 'delete',
                'onclick'   => "openHierarchyDialog('delete')",
            ), -1, 7);
            $this->_addButton('copy', array(
                'label'     => Mage::helper('gri_cms')->__('Copy'),
                'class'     => 'add',
    ...
    {
        return Mage::helper('gri_cms')->__('Manage Pages Hierarchy');
    }
}
