 ...
 */
class Gri_Reward_Model_Action_Newsletter extends Gri_Reward_Model_Action_Abstract
{
    /**
    ...
    {
        return (int)Mage::helper('gri_reward')->getPointsConfig('newsletter', $websiteId);
    }
    ...
    public function getHistoryMessage($args = array())
    {
        ...
        return Mage::helper('gri_reward')->__('Signed up for newsletter with email %s.', $email);
    }
