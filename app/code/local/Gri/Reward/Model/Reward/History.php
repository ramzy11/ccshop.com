 ...
 */
class Gri_Reward_Model_Reward_History extends Mage_Core_Model_Abstract
{
    ...
    {
        $this->_init('gri_reward/reward_history');
    }
    ...
    protected function _beforeSave()
    {
        ...
        $lifetime = (int)Mage::helper('gri_reward')->getGeneralConfig('expiration_days', $this->getWebsiteId());
        if ($lifetime > 0) {
    ...
    public function getMessage()
    {
        if (!$this->hasData('message')) {
            $action = Mage::getSingleton('gri_reward/reward')->getActionInstance($this->getAction());
            $message = '';
            if ($action !== null) {
    ...
    public function getRateText()
    {
        ...
        if (isset($rate['points']) && isset($rate['currency_amount']) && isset($rate['direction'])) {
            return Gri_Reward_Model_Reward_Rate::getRateText(
    ...
    public function getExpiresAt()
    {
        ...
        return Mage::helper('gri_reward')->getGeneralConfig('expiry_calculation') == 'static'
