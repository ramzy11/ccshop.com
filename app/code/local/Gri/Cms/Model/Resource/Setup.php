...
/**
 * Gri Cms Resource Setup model
 *
 * @category    Gri
 * @package     Gri_Cms
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Gri_Cms_Model_Resource_Setup extends Mage_Core_Model_Resource_Setup
{
    /**
     * Fix xpath for hierarchy node table
     *
     * @deprecated since 1.10.0.0
     * @return Gri_Cms_Model_Resource_Setup
     */
    public function fixXpathForHierarchyNode()
    {
        ...
        $select = $connection->select()->from(
            $this->getTable('gri_cms/hierarchy_node'),
    ...
    protected function _updateXpathCallback(array $nodes, $xpath = '', $parentNodeId = 0)
    {
        ...
        foreach ($nodes[$parentNodeId] as $nodeId) {
            ...
            $adapter->update($this->getTable('gri_cms/hierarchy_node'), $bind, $where);
