 ...
 *
 */
class Gri_CustomerBalance_Model_Mysql4_Balance extends Mage_Core_Model_Mysql4_Abstract
{
    /**
    ...
    {
        $this->_init('gri_customerbalance/balance', 'balance_id');
    }

    /**
     * Load customer balance data by specified customer id and website id
     *
     * @param Gri_CustomerBalance_Model_Balance $object
     ...
     * @return Gri_CustomerBalance_Model_Mysql4_Balance
     */
