 ...
 */
class Gri_Cms_Block_Adminhtml_Cms_Page_Revision_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    public function __construct()
    {
        ...
        $this->setTitle(Mage::helper('gri_cms')->__('Revision Information'));
    }
}
