...
class Gri_GiftCard_Model_CatalogIndex_Data_Giftcard extends Mage_CatalogIndex_Model_Data_Simple
{
    protected $_haveChildren = false;

    protected function _construct()
    {
        $this->_init('gri_giftcard/catalogindex_data_giftcard');
    }
    ...
    {
        return Gri_GiftCard_Model_Catalog_Product_Type_Giftcard::TYPE_GIFTCARD;
    }
