 ...
 *
 */
class Gri_CustomerBalance_Helper_Data extends Mage_Core_Helper_Abstract
{
    /**
     * XML configuration paths
     */
    const XML_PATH_ENABLED     = 'customer/gri_customerbalance/is_enabled';
    const XML_PATH_AUTO_REFUND = 'customer/gri_customerbalance/refund_automatically';
