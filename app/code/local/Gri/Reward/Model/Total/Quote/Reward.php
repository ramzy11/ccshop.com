 ...
 */
class Gri_Reward_Model_Total_Quote_Reward extends Mage_Sales_Model_Quote_Address_Total_Abstract
{
     ...
     * @return Gri_Reward_Model_Total_Quote_Reward
     */
    ...
    public function fetch(Mage_Sales_Model_Quote_Address $address)
    {
        ...
        if ($address->getRewardCurrencyAmount()) {
            $address->addTotal(array(
                'code'  => $this->getCode(),
                'title' => Mage::helper('gri_reward')->formatReward($address->getRewardPointsBalance()),
