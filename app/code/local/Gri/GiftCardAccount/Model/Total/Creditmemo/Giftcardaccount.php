...
class Gri_GiftCardAccount_Model_Total_Creditmemo_Giftcardaccount extends Mage_Sales_Model_Order_Creditmemo_Total_Abstract
{
    /**
     * Collect gift card account totals for credit memo
     *
     * @param Mage_Sales_Model_Order_Creditmemo $creditmemo
     * @return Gri_GiftCardAccount_Model_Total_Creditmemo_Giftcardaccount
     */
